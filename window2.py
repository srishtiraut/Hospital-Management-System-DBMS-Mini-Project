...
def menu():
    ...
    m=tkinter.Label(root1,text="MENU",font='Times 20 bold ',fg='black')
    button1=tkinter.Button(root1,text="1.PATIENT REGISTRATION ",command=PAT,bg='white',fg='black')
    button2 = tkinter.Button(root1, text="2.ROOM ALLOCATION   ",bg='white',fg='black',command=Room_all)
    button3 = tkinter.Button(root1, text="3.EMPLOYEE REGISTRATION",bg='white',fg='black',command=emp_screen)
    button4 = tkinter.Button(root1, text="4.BOOK APPOINTMENT  ",bg='white',fg='black',command=appo)
    button5 = tkinter.Button(root1, text="5.PATIENT BILL    ",bg='white',fg='black',command=BILLING)
    button6 = tkinter.Button(root1, text="6.EXIT         ",command=ex,bg='white',fg='black')
    m.place(x=75,y=5)
...
def nothing():
    print("CONTACT DATABASE HEAD ")

def nothing1():
    print("MADE BY ADITYA,SRISHTI,SHITAL,RISHAV")
