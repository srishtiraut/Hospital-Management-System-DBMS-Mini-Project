...
def GET():
    ...
    S1=userbox.get()
    S2=passbox.get()
    if(S1=='mit' and S2=='1234567'):
        menu()
    elif(S1=='mitwpu' and S2=='hospital'):
        menu()
    else:
...
def Entry():
    ...
    bottomframe.pack()
    heading = tkinter.Label(topframe, text="HOSPITAL MANAGEMENT SYSTEM",bg='white',fg='black',font='Times 24 bold')
